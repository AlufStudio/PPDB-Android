...
import app.rumus.ppdb.LoginActivity;
...
@SuppressLint("CommitPrefEdits") public class SessionHandler {
    ...
    private static final String PREF_NAME = "ppdbPref";
     
    // All Shared Preferences Keys
    private static final String IS_LOGIN = "sudahLogin";
     ...
     * */
    public void createLoginSession(String session,String nama,String email){
